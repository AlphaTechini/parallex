...
To find AES-256-GCM encryption and decryption of user-supplied OpenAI keys visit [crypto.ts](file:///C:/Hackathons/Parallex/convex/lib/crypto.ts). The deployment secret it derives from is `OPENAI_KEY_ENCRYPTION_SECRET`.
