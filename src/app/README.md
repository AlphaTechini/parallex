...
To find the root layout, fonts, provider wiring, and pre-hydration theme initialization visit [layout.tsx](file:///C:/Hackathons/Parallex/src/app/layout.tsx) and [providers.tsx](file:///C:/Hackathons/Parallex/src/app/providers.tsx).

To find the authenticated entry redirect visit [page.tsx](file:///C:/Hackathons/Parallex/src/app/page.tsx).

To find global styles, the Tailwind entry, and the light/dark theme tokens visit [globals.css](file:///C:/Hackathons/Parallex/src/app/globals.css).
...
- The root layout applies the saved theme or system preference before hydration, preventing a visible light-to-dark flash during static site startup.
