...
- Controls are lifecycle-only. There is no create or edit form, so every schedule's meaning originates from the conversational tool call that validated it.
